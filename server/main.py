...
from pull_logs import summarize_zone_counts, get_dps_data, get_gear_data, get_raid_pop
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://wow-website-backend.onrender.com", "http://localhost:3000"],
